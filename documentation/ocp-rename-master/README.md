...
1.  [Renaming a master node](#org985cfda)
    1.  [Verify ETCD status](#orgaea3961)
    2.  [Removing the master with the wrong name from the cluster](#org607d64d)
    3.  [Adding the third ETCD member and OpenShift cluster member back to the cluster](#orge6a2a29)
